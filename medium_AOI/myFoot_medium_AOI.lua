...
LAT_MAX = 52.6769672865854020-0.00013889 --tonumber(os.getenv("LAT_MAX"))
NCOLS = 18059
NROWS = 17163 
...
function process_segment(profile, segment)
  ...
  if out_of_bounds == false then
    ...
    if segment.distance ~= 0 and targetData.datum > -42 and sourceData.datum > -42 then -- -42 is No-Data val.
      
      slope = elev_delta / (segment.distance)
      factor = 15.69861691*slope^2 + 1.57411671*slope + 1.06799111  
      segment.weight = segment.weight*factor
      segment.duration = segment.duration*factor
